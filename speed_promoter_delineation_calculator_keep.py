# There must be a file in the directory medianMP_transcriptTSS_<Lineage or species>.tsv.
# When prompted, enter the <Lineage or species> for that file.
...
lineage = input("Which lineage do you want to calculate promoter delineations for?: ")

# Read data once: position (col1), median methylation (col2)
df = pd.read_csv(f"medianMP_transcriptTSS_{lineage}.tsv",
...
out_path = f"{lineage}_promoter_delineations.tsv"
